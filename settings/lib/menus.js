...
┃│✰ ⋟ ${prefix}Threadsvideo (Link)
┃│✰ ⋟ ${prefix}Threadsimg (Link)
┃│✰ ⋟ ${prefix}Multidl (Link)
┃│✰ ⋟ ${prefix}Deezer (Nome) 
...
┃│✰ ⋟ ${prefix}Scep (Número)
┃│✰ ⋟ ${prefix}Promocell (Celular)
┃│✰ ⋟ ${prefix}Games (Nome)
┃│✰ ⋟ ${prefix}Igsh (@usuário)
┃│✰ ⋟ ${prefix}Igsh2 (@usuário)
┃╰══ ⪨
╰╦══════════════════ ⪨
...
┃│✰ ⋟ ${prefix}Totext (Mencionar-audio)
┃│✰ ⋟ ${prefix}Gpt (Texto)
┃│✰ ⋟ ${prefix}Gpt-3.5 (Texto)
┃│✰ ⋟ ${prefix}Imagine (Texto)
┃│✰ ⋟ ${prefix}Bingcreate (Texto)
┃│✰ ⋟ ${prefix}Redacao (Tema)
┃╰══ ⪨
╰╦══════════════════ ⪨
...
┃│✰ ⋟ ${prefix}Banghost
┃│✰ ⋟ ${prefix}Whitelistgroup (numero)
┃│✰ ⋟ ${prefix}Addwhitegroup (numero)
┃│✰ ⋟ ${prefix}Delwhitegroup (numero)
...
┃│✰ ⋟ ${prefix}Whitelistglobal (numero)
┃│✰ ⋟ ${prefix}Addwhiteglobal (numero)
┃│✰ ⋟ ${prefix}Delwhiteglobal (numero)
...
┃│✰ ⋟ ${prefix}Wprivacyph (-all/-cntt/-noall)
┃│✰ ⋟ ${prefix}Wprivacygp (-all/-cntt/-noall)
...
exports.rpgmenu = (prefix, NomeDoBot, sender, NickDono, packname) => {
return `╭═══════════════════ ⪩
...
┃│✰ ⋟ ${prefix}Foguete (valor da aposta)
┃│✰ ⋟ ${prefix}Sortenumber (numero/valor da aposta)
